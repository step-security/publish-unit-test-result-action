...
class PublishTest(unittest.TestCase):
    ...
    def test_label_md(self):
        ...
        self.assertEqual(passed_tests_label_md, f'[:heavy_check_mark:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "passed tests")')
        self.assertEqual(skipped_tests_label_md, f'[:zzz:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "skipped / disabled tests")')
        self.assertEqual(failed_tests_label_md, f'[:x:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "failed tests")')
        self.assertEqual(test_errors_label_md, f'[:fire:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "test errors")')
        self.assertEqual(duration_label_md, f'[:stopwatch:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "duration of all tests")')
    ...
    def test_get_long_summary_without_runs_md_with_errors(self):
        self.assertEqual(get_long_summary_without_runs_md(UnitTestRunResults(
            ...
            runs=4, runs_succ=5, runs_skip=6, runs_fail=7, runs_error=8,
            commit='commit'
        )), (f'4 {all_tests_label_md}   5 {passed_tests_label_md}  3s [:stopwatch:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "duration of all tests")\n'
             f'2 suites  6 {skipped_tests_label_md}\n'
    ...
    def test_file_without_cases(self):
        ...
        stats = get_stats(results)
        md = get_long_summary_md(stats)
        self.assertEqual(md, (f'0 {all_tests_label_md}   0 {passed_tests_label_md}  0s [:stopwatch:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "duration of all tests")\n'
    ...
    def test_file_without_cases_but_with_tests(self):
        ...
        stats = get_stats(results)
        md = get_long_summary_md(stats)
        self.assertEqual(md, (f'6 {all_tests_label_md}   3 {passed_tests_label_md}  0s [:stopwatch:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "duration of all tests")\n'
    ...
    def test_files_with_testsuite_in_testsuite(self):
        ...
        stats = get_stats(results)
        md = get_long_summary_md(stats)
        self.assertEqual(md, (f'5 {all_tests_label_md}   5 {passed_tests_label_md}  4s [:stopwatch:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "duration of all tests")\n'

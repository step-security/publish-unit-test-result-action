...
class TestPublisher(unittest.TestCase):
    ...
    def test_publish_comment_compare_earlier_with_restricted_unicode(self):
        ...
        self.assertEqual(('## title\n'
                          '\u205f\u20041 files\u2004 ±\u205f\u20040\u2002\u2003'
                          '2 suites\u2004 +1\u2002\u2003\u2002'
                          f'3s [:stopwatch:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "duration of all tests") +2s\n'
                          '22 tests +19\u2002\u2003'
                          f'4 [:heavy_check_mark:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "passed tests") +3\u2002\u2003'
                          f'5 [:zzz:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "skipped / disabled tests") +3\u2002\u2003\u205f\u2004'
                          f'6 [:x:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "failed tests") +\u205f\u20046\u2002\u2003\u205f\u2004'
                          f'7 [:fire:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "test errors") +\u205f\u20047\u2002\n'
                          f'38 runs\u2006 +35\u2002\u20038 [:heavy_check_mark:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "passed tests") +7\u2002\u2003'
                          f'9 [:zzz:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "skipped / disabled tests") +7\u2002\u2003'
                          f'10 [:x:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "failed tests") +10\u2002\u2003'
                          f'11 [:fire:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "test errors") +11\u2002\n'
                          '\n'
        ...
        with tempfile.TemporaryDirectory() as path:
            ...
            create_check_run_kwargs = dict(
                ...
                output={
                    ...
                    'summary': f'1 files\u2004\u2003\u205f\u20041 errors\u2004\u20032 suites\u2004\u2003\u20027s [:stopwatch:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols "duration of all tests")\n'
            ...
            with open(filepath, encoding='utf-8') as r:
                ...
                self.assertEqual(
                    ...
                    '"title": "1 parse errors, 1 errors, 3 fail, 2 skipped, 1 pass in 7s", '
                    '"summary": "'
                    f'1 files    1 errors  2 suites   7s [:stopwatch:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols \\"duration of all tests\\")\\n'
                    f'7 tests   1 [:heavy_check_mark:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols \\"passed tests\\") 2 [:zzz:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols \\"skipped / disabled tests\\") 3 [:x:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols \\"failed tests\\") 1 [:fire:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols \\"test errors\\")\\n'
                    f'3 runs  -12 [:heavy_check_mark:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols \\"passed tests\\") 4 [:zzz:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols \\"skipped / disabled tests\\") 5 [:x:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols \\"failed tests\\") 6 [:fire:](https://github.com/step-security/publish-unit-test-result-action/blob/{__version__}/README.md#the-symbols \\"test errors\\")\\n'
                    '\\n'
                    'Results for commit commit.\\n", '
